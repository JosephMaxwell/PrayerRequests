...
use JesseMaxwell\PrayerBundle\Model\UserPeer;
use JesseMaxwell\PrayerBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'JesseMaxwell\\PrayerBundle\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'JesseMaxwell\\PrayerBundle\\Model\\map\\UserTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Enabled', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'enabled', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::ENABLED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'ENABLED', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'enabled', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Enabled' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'enabled' => 2, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::ENABLED => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'ENABLED' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'enabled' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \JesseMaxwell\PrayerBundle\Model\map\UserTableMap());
      }
    }
